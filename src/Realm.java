...
public class Realm {
    ...
    private static void command(String string) throws IOException {
        ...
        switch (string) {
            ...
            break;
            case "3":
                System.out.println(String.format("%s устал и пора домой! У него %d опыта и %d золота, теперь он богат.", player.getName(), player.getXp(), player.getGold()));
                System.exit(1);
                break;
            case "да":
                command("2");
